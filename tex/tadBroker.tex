...
nuevasAccLibres(promesas(dameUno($cs$),$b$), $n$,$c$) +\\ accLibresDspVenta(sinUno($cs$),$n$,$ct$,$a$,$b$) ELSE accLibresDspVenta($p$,sinUno($cs$),$n$,$c$,$a$) FI} FI}
...
l\'imite(dameUno($ps$)) $\textless$ $c$ THEN cantidad(dameUno($ps$)) ELSE nuevasAccLibres(sinUno($p$),$n$,$c$) FI} FI}
